 ...
 */
 ...
 $html ='<html><head><script type="text/javascript" src="catalog/view/javascript/jquery/jquery-2.1.1.min.js"></script>
    ...
    $frameworkClasses = getClasses(DIR_SYSTEM . 'framework.php');
    $textToInsert    = array_unique( array_merge( $properties, $startupClasses, $registryClasses, $catalogModels, $adminModels, $frameworkClasses ) );
